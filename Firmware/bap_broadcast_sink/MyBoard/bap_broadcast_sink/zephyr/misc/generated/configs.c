...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SCAN_DELAY, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TARGET_BROADCAST_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_CODEC_FRAMES_PER_SDU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENABLE_LC3, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_I2S_CODEC_OUTPUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INFO_REPORTING_INTERVAL, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CFG_MAX_DATA_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CFG_MAX_METADATA_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_BASS_MAX_SUBGROUPS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CAP_MAX_DATA_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CAP_MAX_METADATA_SIZE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 70);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_RX_BUF_COUNT, 8);
