...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BAP_BROADCAST_16_2_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BROADCAST_CODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STATIC_BROADCAST_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BROADCAST_ID, 0x123456);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52820DONGLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52820DONGLE_NRF52820, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_BUF_COUNT, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_MTU, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_TX_BUFFERS, 6);
